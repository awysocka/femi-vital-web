...
const Footer = () => {
  return (
    <Wrapper>
      <Content>
        <LogoContainer>
          <StaticImage src='../../assets/images/femi-vital-logo.png' alt='Logo firmy' objectFit />
        </LogoContainer>
        <SocialMediaContainer>
          <a
        ...
        <p>
          Wykonanie
          <a href='https://annawysocka.pl/' target='_blank' rel='noopener noreferrer'>Anna Wysocka</a>
        </p>
      </Content>
      <RoundBackground />
    </Wrapper>
